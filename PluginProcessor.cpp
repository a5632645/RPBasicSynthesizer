...
//==============================================================================
const juce::String RPBasicSynthesizerAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool RPBasicSynthesizerAudioProcessor::acceptsMidi() const
{
...
bool RPBasicSynthesizerAudioProcessor::producesMidi() const
{
...
bool RPBasicSynthesizerAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double RPBasicSynthesizerAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int RPBasicSynthesizerAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int RPBasicSynthesizerAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
//==============================================================================
void RPBasicSynthesizerAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool RPBasicSynthesizerAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void RPBasicSynthesizerAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    m_synthesizer.processBlock(midiMessages, buffer);
}

//==============================================================================
bool RPBasicSynthesizerAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* RPBasicSynthesizerAudioProcessor::createEditor()
{
    return new RPBasicSynthesizerAudioProcessorEditor (*this);
}

//==============================================================================
void RPBasicSynthesizerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
{
    return new RPBasicSynthesizerAudioProcessor();
}
