...
void Phaser4Pos::reset() {
    for (auto& f : m_apfs) {
        f.reset();
    }
}

void Phaser4Pos::prepare(FType sampleRate, size_t numSamples) {
    m_sampleRate = sampleRate;
}

void Phaser4Pos::doLayout(ui::FilterKnobsPanel& p) {
